...
namespace JsonPatch.Tests
{
	...
	public class JsonPatchDocumentTests
	{
		...
		[TestMethod]
		public void Test_ValidPaths_OperationAdded()
		{
			//Arrange
			var patchDocument = new JsonPatchDocument<SimpleEntity>();

			//Act
			patchDocument.Test("Foo", "Baz");
		...
		[TestMethod]
		public void Test_ArrayIndexes_OperationAdded()
		{
			//Arrange
			var patchDocument = new JsonPatchDocument<ArrayEntity>();

			//Act
			patchDocument.Test("Foo/5", "Value");
		...
		[TestMethod, ExpectedException(typeof(JsonPatchParseException))]
		public void Test_InvalidFromPath_ThrowsJsonPatchParseException()
		{
			//Arrange
			var patchDocument = new JsonPatchDocument<SimpleEntity>();

			//Act
			patchDocument.Test("FooMissing", "Baz");
		}
		...
		[TestMethod]
		public void ApplyUpdate_TestOperation_Passed()
		{
			//Arrange
			var patchDocument = new JsonPatchDocument<SimpleEntity>();
			var entity = new SimpleEntity { Foo = "bar" };
		...
		public void ApplyUpdate_TestOperation_Array_Passed()
		{
			//Arrange
			var patchDocument = new JsonPatchDocument<ArrayEntity>();
			var entity = new ArrayEntity { Foo = new string[] { "bar1", "bar2" } };

			//Act
			patchDocument.Test("Foo/1", "bar2");
			patchDocument.ApplyUpdatesTo(entity);
		}
